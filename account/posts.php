                                ...
                                <div class="blog_post_sec blog_post_inner">
                                    <div class="row">
                                        ...
                                        while ($post = $get_posts->fetch_assoc()) {
                                            ...
                                            $get_user = $con->query("SELECT name from users where id= '$user_id' LIMIT 3 ");
                                            ...
                                            <div class="blog-post_wrapper image-wrapper">
                                                ...
                                                <div class="post-content">
                                                    <div class="post-category">
                                                        <ul>
                                                            <li class="cat-yellow"><a href="post.php" class="white"><?php echo $post['category']?></a></li>
                                                           
                                                        </ul>
                                                    </div>
                                                    <div class="post-date">
                                                        <p><a href="#"><?php echo $post['category']?></a></p>
                                                    </div>
                                                    ...
                                                    <div class="item-meta white">
                                                        <span>by</span>
                                                        <a class="author-name white" href="post.php"><?php echo $post_owner?></a>
                                                    </div>
